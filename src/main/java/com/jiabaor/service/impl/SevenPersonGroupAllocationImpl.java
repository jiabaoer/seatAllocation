...
@Service
public class SevenPersonGroupAllocationImpl implements SevenPersonGroupAllocation {
	 ...
	 * 2.找七个相邻的座位存到meetGroupSeatList集合，如果没有相邻座位就调用单人分配方法
	 */
	// 七人组
	public boolean sevenUserGroupAllocation(int a, List<User> groupList, List<User> randomAndDissatisfylist,
		...
		for (int j1 = 0; j1 < seatList.size(); j1++) {
			...
			if (j1 < seatList.size() && (j1 + 1) < seatList.size() && (j1 + 2) < seatList.size()
					&& (j1 + 3) < seatList.size() && (j1 + 4) < seatList.size()
					&& ((j1 + 5) < seatList.size() && (j1 + a) < seatList.size())) {
				if ((0 <= j1 % a && j1 % a < a) && (1 <= (j1 + 1) % a && (j1 + 1) % a < a)
						&& (2 <= (j1 + 2) % a && (j1 + 2) % a < a) && (3 <= (j1 + 3) % a && (j1 + 3) % a < a)
			...
			if (j1 < seatList.size() && (j1 + 1) < seatList.size() && (j1 + 2) < seatList.size()
					&& (j1 + 3) < seatList.size() && (j1 + 4) < seatList.size()
					&& ((j1 + 5) < seatList.size() && (j1 + (a + 1)) < seatList.size())) {
				if ((0 <= j1 % a && j1 % a < a) && (1 <= (j1 + 1) % a && (j1 + 1) % a < a)
						&& (2 <= (j1 + 2) % a && (j1 + 2) % a < a) && (3 <= (j1 + 3) % a && (j1 + 3) % a < a)
						&& (4 <= (j1 + 4) % a && (j1 + 4) % a < a) && (5 <= (j1 + 5) % a && (j1 + 5) % a < a)
						&& (1 <= (j1 + (a + 1)) % a && (j1 + (a + 1)) % a < a)) {
			...
			if (j1 < seatList.size() && (j1 + 1) < seatList.size() && (j1 + 2) < seatList.size()
					&& (j1 + 3) < seatList.size() && (j1 + 4) < seatList.size()
					&& ((j1 + 5) < seatList.size() && (j1 + (a + 2)) < seatList.size())) {
				if ((0 <= j1 % a && j1 % a < a) && (1 <= (j1 + 1) % a && (j1 + 1) % a < a)
						&& (2 <= (j1 + 2) % a && (j1 + 2) % a < a) && (3 <= (j1 + 3) % a && (j1 + 3) % a < a)
						&& (4 <= (j1 + 4) % a && (j1 + 4) % a < a) && (5 <= (j1 + 5) % a && (j1 + 5) % a < a)
						&& (2 <= (j1 + (a + 2)) % a && (j1 + (a + 2)) % a < a)) {
			...
			if (j1 < seatList.size() && (j1 + 1) < seatList.size() && (j1 + 2) < seatList.size()
					&& (j1 + 3) < seatList.size() && (j1 + 4) < seatList.size()
					&& ((j1 + 5) < seatList.size() && (j1 + (a + 3)) < seatList.size())) {
				if ((0 <= j1 % a && j1 % a < a) && (1 <= (j1 + 1) % a && (j1 + 1) % a < a)
						&& (2 <= (j1 + 2) % a && (j1 + 2) % a < a) && (3 <= (j1 + 3) % a && (j1 + 3) % a < a)
						&& (4 <= (j1 + 4) % a && (j1 + 4) % a < a) && (5 <= (j1 + 5) % a && (j1 + 5) % a < a)
						&& (3 <= (j1 + (a + 3)) % a && (j1 + (a + 3)) % a < a)) {
			...
			if (j1 < seatList.size() && (j1 + 1) < seatList.size() && (j1 + 2) < seatList.size()
					&& (j1 + 3) < seatList.size() && (j1 + 4) < seatList.size()
					&& ((j1 + 5) < seatList.size() && (j1 + (a + 4)) < seatList.size())) {
				if ((0 <= j1 % a && j1 % a < a) && (1 <= (j1 + 1) % a && (j1 + 1) % a < a)
						&& (2 <= (j1 + 2) % a && (j1 + 2) % a < a) && (3 <= (j1 + 3) % a && (j1 + 3) % a < a)
						&& (4 <= (j1 + 4) % a && (j1 + 4) % a < a) && (5 <= (j1 + 5) % a && (j1 + 5) % a < a)
						&& (4 <= (j1 + (a + 4)) % a && (j1 + (a + 4)) % a < a)) {
			...
			if (j1 < seatList.size() && (j1 + 1) < seatList.size() && (j1 + 2) < seatList.size()
					&& (j1 + 3) < seatList.size() && (j1 + 4) < seatList.size()
					&& ((j1 + 5) < seatList.size() && (j1 + (a + 5)) < seatList.size())) {
				if ((0 <= j1 % a && j1 % a < a) && (1 <= (j1 + 1) % a && (j1 + 1) % a < a)
						&& (2 <= (j1 + 2) % a && (j1 + 2) % a < a) && (3 <= (j1 + 3) % a && (j1 + 3) % a < a)
						&& (4 <= (j1 + 4) % a && (j1 + 4) % a < a) && (5 <= (j1 + 5) % a && (j1 + 5) % a < a)
						&& (5 <= (j1 + (a + 5)) % a && (j1 + (a + 5)) % a < a)) {
