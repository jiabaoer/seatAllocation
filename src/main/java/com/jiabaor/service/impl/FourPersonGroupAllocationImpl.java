...
@Service
public class FourPersonGroupAllocationImpl implements FourPersonGroupAllocation {
	 ...
	 * 2.找四个相邻的座位存到meetGroupSeatList集合，如果没有相邻座位就调用单人分配方法
	 */
	// 四人组
	public boolean fourUserGroupAllocation(int a, List<User> groupList, List<User> randomAndDissatisfylist,
